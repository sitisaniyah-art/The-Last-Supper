...
var CATEGORY_ACCENTS = {
  '数学与统计类': ['#6366f1', '#818cf8'],
  '计算机科学与技术类': ['#10b981', '#34d399'],
  '电子信息与电气工程类': ['#0ea5e9', '#38bdf8'],
  '机械与能源工程类': ['#f97316', '#fb923c'],
  '材料科学与工程类': ['#a855f7', '#c084fc'],
  '物理学类': ['#ef4444', '#f87171'],
  '化学与化工类': ['#14b8a6', '#2dd4bf'],
  '生命科学与医学类': ['#22c55e', '#4ade80'],
  '地球与空间科学类': ['#0d9488', '#2dd4bf'],
  '土木水利与建筑类': ['#d97706', '#fbbf24'],
  '交通运输与航空航天类': ['#3b82f6', '#60a5fa'],
  '环境与安全科学类': ['#65a30d', '#a3e635'],
  '农学与食品科学类': ['#84cc16', '#bef264'],
  '经济与管理类': ['#eab308', '#facc15'],
  '法学与政治学类': ['#dc2626', '#f87171'],
  '人文与教育类': ['#ec4899', '#f472b6'],
  '艺术与设计类': ['#f43f5e', '#fb7185'],
  '交叉学科类': ['#8b5cf6', '#a78bfa'],
  '公共基础类': ['#64748b', '#94a3b8'],
  '综合类': ['#78716c', '#a8a29e']
};
